	...
	{id: "3",
	 ...
	 more: [{icon: "mute", name: "Mute new mentions on this page", description:"Don't notify about mentions on talk:Burrito"}]},
{id: "4",
	 project: "Wikipedia",
	 language: "English",
	 icon: "talk",
...
{id: "5",
	 ...
	 more: [{icon: "mute", name: "Mute file updates", description:"Don't notify new edits for \"Exploding light bulb\""}]},
{id: "7",
	 project: "Wikipedia",
	 language: "Spanish",
	 icon: "flow-usertalk-post-reply",
...
{id: "8",
	 ...
	 more: [{icon: "mute", name: "Mute thanks on this page", description:"Don't notify thanks for Quesadilla mexicana"}]},
{id: "6",
	 project: "Commons",
	 language: "",
	 icon: "picture",
	 ...
	 more: [{icon: "mute", name: "Mute file updates", description:"Don't notify new edits for Pillars of Creation"}]},
{id: "9",
	 project: "Wikipedia",
	 language: "Spanish",
	 icon: "thanks",
