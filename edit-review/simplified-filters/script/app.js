...
function showPanelForPrefix(){
  ...
  $(".search-actions .add-more").removeClass("active");
}
...
function clearPanels(e){
  ...
  if($(e.target).closest(".search-actions .add-more").length == 0){
    $(".search-actions .add-more").removeClass("active");
  }
...
function showNewChanges(){
  $(".new-changes").append("<div class='old-changes-separator'>Previously viewed changes</div>");
...
$(function(){ //Initialization:
  ...
  $(".search-actions .add-tag").click(function(e){showEditTagPanel(); return false;});
  $(".search-actions .add-namespace").click(function(e){showNamespacesPanel(); return false;});
  $(".search-actions .add-user").click(function(e){showUsersPanel(); return false;});
  $(".search-actions .add-category").click(function(e){showCategoryPanel(); return false;});
